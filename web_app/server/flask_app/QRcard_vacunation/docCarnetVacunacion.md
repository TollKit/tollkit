...
<ul>
  <li>Atravez de Selenium y el lenguaje de programación de Python, comanzaremos controlando mediante un WebDriver el navegador que usaremos, por ejemplo si quisieramos controlar desde el navegador Chrome será:
